...
public class ListAlbumAdapter extends ArrayAdapter<ImageModel> {
    ...
    public ListAlbumAdapter(Context context, int layoutResourceId, ArrayList<ImageModel> data) {
        ...
        this.data = data;
        this.pHeightItem = getDisplayInfo((AppCompatActivity) context).widthPixels / 3;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).asBitmap().load(item.getPathFile()).placeholder(R.drawable.piclist_icon_default).into(holder.imageItem);
