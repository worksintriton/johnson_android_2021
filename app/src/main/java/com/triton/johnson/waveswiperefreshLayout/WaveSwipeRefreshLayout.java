...
import com.triton.johnson.maintain.MoniterFragmetTime;
...
public class WaveSwipeRefreshLayout extends ViewGroup
    ...
    /**
     *MAX_PROGRESS_ROTATION_RATE
     */
    private static final float MAX_PROGRESS_ROTATION_RATE = 0.8f;

    /**
     * {@link WaveSwipeRefreshLayout#mCircleView} SCALE_DOWN_DURATION
     */
    ...
    /**
     * {@link WaveSwipeRefreshLayout#mAnimateToCorrectPosition }Interpolator
     */
     ...
     */
    public void setOnRefreshListener(MoniterFragmetTime listener) {
        mListener = (OnRefreshListener) listener;
    }
