...
import com.triton.johnson.adapter.AllListAdapter;
...
public class CheckerFragment  extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle arg) {
        final View view = inflater.inflate(R.layout.checker_fragment, container,
                false);
        ...
        recyclerView.addOnItemTouchListener(
                new DepartmentListClass.RecyclerItemClickListener(getActivity(), (view13, position) -> {
                    // TODO Handle item click
                    // Call Schedule or Home screen.
                    CheckerTimeFragment orderManagement = new CheckerTimeFragment();
        ...
        if (networkStatus.equalsIgnoreCase("Not connected to Internet")) {
            ...
            allListAdapter = new AllListAdapter( allListArrayList);
