...
import com.triton.johnson.adapter.CheckerTimeAdapter;
...
public class CheckerTimeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (networkStatus.equalsIgnoreCase("Not connected to Internet")) {
            ...
            CheckerTimeAdapter allFragmentTimeAdapter = new CheckerTimeAdapter(getActivity(), allTimeListArrayList);
        ...
        view.setOnKeyListener((v, keyCode, event) -> {
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                if (keyCode == KeyEvent.KEYCODE_BACK) {
                    CheckerFragment orderManagement = new CheckerFragment();
