...
public class ChangePasswordForDepartmentFragment extends Fragment implements OnKeyboardVisibilityListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // String userLevel = hashMap.get(SessionManager.KEY_USER_LEVEL);
        ...
        sidemenuLayout.setOnClickListener(view14 -> MAinfragmentActivty.drawerLayout.openDrawer(MAinfragmentActivty.nvDrawer));
        wholeLayout.setOnClickListener(view15 -> {
        ...
        submitButton.setOnClickListener(view16 -> {
        ...
        view.setOnKeyListener((v, keyCode, event) -> {
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                if (keyCode == KeyEvent.KEYCODE_BACK) {
                    Intent intent = new Intent(getActivity(), MAinfragmentActivty.class);
